        ...
        <div class="row pt-5">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 mt-5">
            ...
            <div class="card card-primary mt-lg-5">
              <div class="card-header text-center text-primary"><h5>Sistem Pendataan inventory barang</h5></div>

              <div class="card-body">
                <form method="POST" action="<?php echo base_url()?>login/proses" class="needs-validation" novalidate="">
            ...
            <div class="simple-footer">
              Copyright &copy; 2021. Sakha Ardiansyah
            </div>
          </div>
        </div>
      </div>
